...
MariaDB [csd2204s18]> SELECT count
    -> (*),MANUFACTURER
    -> FROM products as p
    -> INNER JOIN manu m
...
FROM products as p
INNER JOIN manu m
ON m.code = p.manufacturer ' at line 2
...
MariaDB [csd2204s18]> select manufacturer, m.name, COUNT(*) "No. of items produces" FROM products as p INNE
    -> R JOIN
    -> ;
...
R JOIN' at line 1
MariaDB [csd2204s18]> select manufacturer, m.name, COUNT(*) "No. of items produces" FROM products as p
    -> INNER JOIN manu m ON m.code = p.manufacturer;
+--------------+------+-----------------------+
| manufacturer | name | No. of items produces |
+--------------+------+-----------------------+
|            1 | Sony |                    13 |
+--------------+------+-----------------------+
...
MariaDB [csd2204s18]>  select manufacturer, m.name, COUNT(*) "No. of items produces" FROM products as p
    ->     -> INNER JOIN manu m ON m.code = p.manufacturer GROUP BY manufacturer;
ERROR 1064 (42000): You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near '-> INNER JOIN manu m ON m.code = p.manufacturer GROUP BY manufacturer' at line 2
MariaDB [csd2204s18]>  select manufacturer, m.name, COUNT(*) "No. of items produces" FROM products as p INNER JOIN manu m
    -> on m.code=p.manufacturer GROUP BY manufacturer;
+--------------+-------------------+-----------------------+
| manufacturer | name              | No. of items produces |
+--------------+-------------------+-----------------------+
...
MariaDB [csd2204s18]>  select manufacturer, m.name, COUNT(*) "No. of items produced" FROM products as p INNER JOIN manu ON m
    -> on m.code=p.manufacturer WHERE m.code<4 GROUP BY manufacturer;
ERROR 1064 (42000): You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near 'on m.code=p.manufacturer WHERE m.code<4 GROUP BY manufacturer' at line 2
MariaDB [csd2204s18]>  select manufacturer, m.name, COUNT(*) "No. of items manufacurer have" FROM products as p INNER JOIN manu ON m
    -> on m.code = p.manufacurer WHERE m.code<4 GROUP BY manufacturer;
ERROR 1064 (42000): You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near 'on m.code = p.manufacurer WHERE m.code<4 GROUP BY manufacturer' at line 2
MariaDB [csd2204s18]>  select manufacturer, m.name, COUNT(*) "No. of items manufacurer have" FROM products as p INNER JOIN manu m
    -> on m.code = p.manufacurer WHERE m.code<4 GROUP BY manufacturer;
ERROR 1054 (42S22): Unknown column 'p.manufacurer' in 'on clause'
MariaDB [csd2204s18]> 
MariaDB [csd2204s18]> 
MariaDB [csd2204s18]> 
MariaDB [csd2204s18]> 
MariaDB [csd2204s18]> 
MariaDB [csd2204s18]> select manufacturer, m.name, COUNT(*) "No. of items manufacurer have" FROM products as p INNER JOIN manu m ON m.code=p.manufacturer WHERE m.code IN(2,3) GROUP BY manufacturer;
+--------------+-----------------+-------------------------------+
| manufacturer | name            | No. of items manufacurer have |
+--------------+-----------------+-------------------------------+
|            2 | Creative Labs   |                             3 |
|            3 | Hewlett-Packard |                             2 |
+--------------+-----------------+-------------------------------+
...
MariaDB [csd2204s18]> select manufacturer, m.name, COUNT(*) "No. of items manufacurer have" FROM products as p INNER JOIN manu m ON m.code=p.manufacturer WHERE m.code IN(2,3) GROUP BY manufacturer having count(*)>2;
+--------------+---------------+-------------------------------+
| manufacturer | name          | No. of items manufacurer have |
+--------------+---------------+-------------------------------+
|            2 | Creative Labs |                             3 |
...
MariaDB [csd2204s18]> select manufacturer, m.name, COUNT(*) "No. of items manufacurer have" FROM products as p INNER JOIN manu m ON m.code=p.manufacturer WHERE m.code = 3 or m.code = 2 GROUP BY manufacturer;
+--------------+-----------------+-------------------------------+
| manufacturer | name            | No. of items manufacurer have |
+--------------+-----------------+-------------------------------+
|            2 | Creative Labs   |                             3 |
...
MariaDB [csd2204s18]> select products.code, products.name, manu.name from products RIGHT JOIN PRODUCTS ON PRODUCTS.MANUFACTURER = MANU.CODE;
